...
const EditChampagnes = ({data, handleClose, handleSuccess}) => {
  ...
  const editChampagne = async (info) => {
    setIsLoading(true);
    axios
      .patch("http://150.136.140.225:3700/api/public/Champagnes/update", info)
      .then((response) => {
    ...
    return (
        ...
        <Box display="flex" justifyContent="end">
          <DialogActions>
            ...
            >
              {isLoading ? "Loading..." : "Edit Champagnes"}
            </Button>
          </DialogActions>
        </Box>
      </form>
