import {
  ...
  const AddNewChampagnes = ({ handleClose, handleSuccess }) => {
    ...
    const addChampagne = async (info) => {
      setIsLoading(true);
      axios
        .post("http://150.136.140.225:3700/api/public/Champagnes/create", info)
        .then((response) => {
        ...
        <form>
          ...
          <Box display="flex" justifyContent="end">
            <DialogActions>
              ...
              >
                {isLoading ? "Loading..." : "Add Champagnes"}
              </Button>
            </DialogActions>
          </Box>
        </form>
  ...
  export default AddNewChampagnes;
