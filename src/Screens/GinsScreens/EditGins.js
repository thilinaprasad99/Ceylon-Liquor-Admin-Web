...
const EditGins = ({data, handleClose, handleSuccess}) => {
  ...
  const editGin = async (info) => {
    setIsLoading(true);
    axios
      .patch("http://150.136.140.225:3700/api/public/Gins/update", info)
      .then((response) => {
