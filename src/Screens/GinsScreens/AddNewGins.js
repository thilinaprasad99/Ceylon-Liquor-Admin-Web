import {
  ...
  const AddNewGins = ({ handleClose, handleSuccess }) => {
    ...
    const addGin = async (info) => {
      setIsLoading(true);
      axios
        .post("http://150.136.140.225:3700/api/public/Gins/create", info)
        .then((response) => {
