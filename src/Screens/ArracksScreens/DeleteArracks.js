...
const DeleteArracks = ({data,handleClose,handleSuccess}) => {
  ...
  const [isLoading, setIsLoading] = useState(false);
    ...
    const deleteArrack = async (id) => {
        setIsLoading(true);
        axios
          .delete(`http://150.136.140.225:3700/api/public/arracks/delete/${id}`)
          .then((response) => {
