import {
  ...
  const AddNewBrandys = ({ handleClose, handleSuccess }) => {
    ...
    const addBrandy = async (info) => {
      setIsLoading(true);
      axios
        .post("http://150.136.140.225:3700/api/public/Brandys/create", info)
        .then((response) => {
