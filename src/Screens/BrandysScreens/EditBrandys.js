...
const EditBrandys = ({data, handleClose, handleSuccess}) => {
  ...
  const editBrandy = async (info) => {
    setIsLoading(true);
    axios
      .patch("http://150.136.140.225:3700/api/public/Brandys/update", info)
      .then((response) => {
    ...
    return (
        ...
        <Box display="flex" justifyContent="end">
          <DialogActions>
            ...
            >
              {isLoading ? "Loading..." : "Edit Brandys"}
            </Button>
          </DialogActions>
        </Box>
      </form>
