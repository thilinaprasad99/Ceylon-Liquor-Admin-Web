...
const DeleteRums = ({data,handleClose,handleSuccess}) => {
  ...
  const [isLoading, setIsLoading] = useState(false);
    ...
    const deleteRums = async (id) => {
        setIsLoading(true);
        axios
          .delete(`http://150.136.140.225:3700/api/public/Rums/delete/${id}`)
          .then((response) => {
