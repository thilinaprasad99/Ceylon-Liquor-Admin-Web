import {
  ...
  const AddNewRums = ({ handleClose, handleSuccess }) => {
    ...
    const addRums = async (info) => {
      setIsLoading(true);
      axios
        .post("http://150.136.140.225:3700/api/public/Rums/create", info)
        .then((response) => {
